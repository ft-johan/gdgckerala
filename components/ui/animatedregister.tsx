...
export function Animatedregister() {
  ...
  return (
    <div className="py-32 md:py-12 flex items-center justify-center">
      <Modal>
        <ModalTrigger className=" text-white h-16 ease-in-out duration-300 z-20 w-52 bg-[#ea4335] hover:bg-white hover:text-[#ea4335] text-md md:text-xl rounded-full  flex justify-center group/modal-btn p-4">
        ...
        <ModalBody>
          ...
          <ModalFooter className="gap-4">
            ...
            <button className="bg-black text-white dark:bg-white dark:text-black text-sm px-2 py-1 rounded-md border border-black w-28">
             <a href="https://gdg.community.dev/events/details/google-gdg-on-campus-indian-institute-of-information-technology-kottayam-india-presents-wow-summit-2025/"> Book Now</a>
            </button>
          </ModalFooter>
        </ModalBody>
      </Modal>
